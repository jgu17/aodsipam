...
VERSION_LDFLAGS="-X aodsipam/pkg/version.Version=${VERSION} \
-X aodsipam/pkg/version.GitSHA=${GIT_SHA} \
-X aodsipam/pkg/version.GitTreeState=${GIT_TREE_STATE} \
-X aodsipam/pkg/version.ReleaseStatus=${RELEASE_STATUS}"
